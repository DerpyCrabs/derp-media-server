...
import type { BookDocument } from '@/features/reader/contentTypes/book/book-types'
...
describe('book sanitization', () => {
  test('drops bare stylesheet at-rules instead of copying unmatched CSS', async () => {
    const { renderBook } = await import('@/features/reader/contentTypes/book/book-sanitize')
