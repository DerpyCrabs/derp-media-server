...
**Already in Solid:** [`smoke.spec.ts`](../tests/e2e-solid/smoke.spec.ts), [`login.spec.ts`](../tests/e2e-solid/login.spec.ts) (mirror of React login/share stub expectations).
