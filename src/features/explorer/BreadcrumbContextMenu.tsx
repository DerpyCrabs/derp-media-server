import type { BreadcrumbFolderMenuTarget } from '@/features/explorer/breadcrumb-floating-store'
    ...
    >
      {(ctx) => (
        <>
          ...
          <Show when={props.showOpenInOtherSurface}>
            <button
              type='button'
              data-slot='context-menu-item'
