    ...
    IntegrationModule {
        descriptor: IntegrationDescriptorDto {
            ...
            capabilities: vec![
                ...
                IntegrationCapabilityDto::Panes,
                IntegrationCapabilityDto::Events,
            ],
        ...
        assistant: Some(runtime.clone()),
        panes: Some(runtime.clone()),
        events: Some(runtime.clone()),
        change: None,
        shutdown: Some(runtime),
