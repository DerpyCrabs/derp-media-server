...
export async function readSettings(): Promise<Settings> {
  ...
  const settings = allSettings[config.libraryKey] || { ...DEFAULT_SETTINGS }
  return {
    ...
    workspaceTaskbarPins: filterAdminWorkspaceTaskbarPins(
      parseWorkspaceTaskbarPins(settings.workspaceTaskbarPins),
    ),
    workspaceLayoutPresets: sanitizeAdminWorkspaceLayoutPresets(
      parseWorkspaceLayoutPresetsList(settings.workspaceLayoutPresets),
    ),
  }
}
